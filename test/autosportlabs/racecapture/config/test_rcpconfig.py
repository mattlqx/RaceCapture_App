...
CAN_CHANNEL_1 = '{"nm":"CHAN1", "ut": "UNITS1", "min":-55, "max":55,"prec":2,"sr":25, "bm": false, "type":0, "bus":0, "id":1234, "idMask":0, "offset":23, "len":19, "subId":-1, "mult":1.23, "div":3.45, "add":3, "bigEndian":false, "filtId": 3}'
CAN_CHANNEL_2 = '{"nm":"CHAN2", "ut": "UNITS2", "min":-66, "max":66,"prec":3,"sr":50, "bm": true, "type":0, "bus":1, "id":1235, "idMask":0, "offset":24, "len":20, "subId":-1, "mult":1.24, "div":6.78, "add":4, "bigEndian":true, "filtId": 4}'
...
class BaseConfigTest(unittest.TestCase):
    ...
    def assert_dicts_equal(self, json_dict1, json_dict2):
        self.assertEqual(json_dict1, json_dict2)

class CANMappingTest(BaseConfigTest):
    def test_can_mapping(self):
        can_mapping_json_dict = self.from_json_string('{"filtId":3,"bm":false,"idMask":0,"len":19,"subId":-1,"add":3,"mult":1.23,"offset":23,"div":3.45,"bigEndian":false,"type":0,"id":1234,"bus":0}')
