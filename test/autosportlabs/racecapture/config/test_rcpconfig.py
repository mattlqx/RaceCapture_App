...
CAN_CHANNEL_1 = '{"nm":"CHAN1", "ut": "UNITS1", "min":-55, "max":55,"prec":2,"sr":25, "map": {"bm": 0, "type":0, "chan":0, "id":1234, "id_mask":0, "offset":23, "len":19, "mult":1.23, "div":3.45, "add":3, "endian":0, "filt_id": 3}}'
CAN_CHANNEL_2 = '{"nm":"CHAN2", "ut": "UNITS2", "min":-66, "max":66,"prec":3,"sr":50, "map": {"bm": 1, "type":0, "chan":1, "id":1235, "id_mask":0, "offset":24, "len":20, "mult":1.24, "div":6.78, "add":4, "endian":1, "filt_id": 4}}'
...
class CANMappingTest(BaseConfigTest):
    def test_can_mapping(self):
        can_mapping_json_dict = self.from_json_string('{"bm": 0, "type":0, "chan":0, "id":1234, "id_mask":0, "offset":23, "len":19, "mult":1.23, "div":3.45, "add":3, "endian":0, "filt_id": 3}')
